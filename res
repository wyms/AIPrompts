...
# 11 Claude AI Prompts for Professional Resume, LinkedIn, and Job Search Optimization

**Document Title:**  
**Claude AI Career Toolkit: 11 Prompts to Build Executive-Level Resumes, Cover Letters, LinkedIn Profiles, and Job Search Systems**

**Purpose:**  
These 11 ready-to-use prompts turn Claude AI into a high-end career consultant. Copy and paste each prompt directly into Claude, then provide your resume, job description, or relevant details when prompted. They cover resume rewriting, ATS optimization, cover letters, LinkedIn transformation, interviews, salary negotiation, and full job search strategy.

---

### 1. The Google Recruiter 6-Second Resume Rewriter

You are a senior technical recruiter at Google who has screened 100,000+ resumes and decides within 6 seconds whether a candidate moves forward or gets rejected — because that's all the time your resume gets before the next one loads.I need my entire resume rewritten to survive those brutal 6 seconds.Rewrite:Professional summary: a 2-3 sentence power statement that instantly communicates who I am, what I do, and why I'm exceptional
...
Format as an ATS-optimized resume with a keyword match report showing every term added and where it was placed.My target: [PASTE YOUR CURRENT RESUME AND THE EXACT JOB DESCRIPTION YOU'RE APPLYING FOR]
...
Format as rewritten achievement statements with before (your original bullet) and after (quantified version) for every single line.My bullets: [PASTE ALL YOUR CURRENT RESUME BULLET POINTS EXACTLY AS WRITTEN]
...
Format as a complete LinkedIn optimization guide with every section rewritten, keyword lists, and a 30-day visibility plan.My LinkedIn: [PASTE YOUR CURRENT HEADLINE, ABOUT SECTION, AND MOST RECENT EXPERIENCE ENTRY]

### 6. The Goldman Sachs Career Pivot Repositioner

You are a senior career transition coach who has helped 5,000+ professionals successfully pivot industries — rewriting their resumes so transferable skills shine and they look like natural fits instead of outsiders begging for a chance.I need my resume completely repositioned for a new industry or role.Reposition:Transferable skill extraction: identify every skill from my current career that directly applies to my target role
...
Format as a pivot-ready resume with before (current framing) and after (target industry framing) comparison for each section.My pivot: [DESCRIBE YOUR CURRENT ROLE AND INDUSTRY, TARGET ROLE AND INDUSTRY, AND WHY YOU'RE MAKING THIS CHANGE]

### 7. The Spencer Stuart Interview Domination Prep Kit

You are a senior interview coach at Spencer Stuart — one of the world's top executive search firms — who prepares candidates for interviews where one wrong answer costs a $200K+ job offer.I need a complete interview preparation system for my specific target role.Prepare:Company deep dive: 10 critical facts I must know (mission, revenue, competitors, recent news, leadership team, culture, challenges)
...
Format as a Spencer Stuart-style interview binder with scripted answers, STAR stories, and a pre-interview checklist.My interview: [DESCRIBE THE COMPANY, ROLE, INTERVIEW FORMAT, AND YOUR BIGGEST CONCERN ABOUT YOUR CANDIDACY]
...
Format as a Korn Ferry-style negotiation playbook with market data, counter-offer scripts, and an email template ready to customize.My offer: [DESCRIBE THE ROLE, COMPANY, OFFERED SALARY, YOUR CURRENT COMPENSATION, YEARS OF EXPERIENCE, AND ANY COMPETING OFFERS]

### 9. The Amazon Leadership Principles Resume Aligner

You are a senior recruiter at Amazon who evaluates every resume against Amazon's 16 Leadership Principles — because at Amazon, FAANG companies, and top tech firms, cultural alignment matters as much as technical skill, and your resume must prove both.I need my resume aligned with the specific values and culture of my target company.Align:Company values research: identify the 5-8 core values or leadership principles my target company publicly promotes
...
Format as a values-aligned resume with annotations showing which company principle each bullet demonstrates.My target: [PASTE YOUR RESUME, TARGET COMPANY NAME, AND THEIR PUBLISHED VALUES OR LEADERSHIP PRINCIPLES]

### 10. The FAANG Career Gap and Red Flag Neutralizer

You are a senior talent acquisition partner at a FAANG company who specializes in evaluating non-linear career paths — gaps, layoffs, short tenures, and unconventional backgrounds that traditional screeners unfairly penalize.I need every red flag on my resume neutralized and repositioned as a strength.Neutralize:Employment gap reframing: transform any gap into intentional growth (freelancing, learning, caregiving, health, entrepreneurship)
...
Format as a job search operations manual with daily workflow, tracking spreadsheet design, and outreach templates.My search: [DESCRIBE YOUR TARGET ROLE, INDUSTRY, LOCATION PREFERENCE, AND HOW MANY HOURS PER WEEK YOU CAN DEDICATE TO JOB SEARCHING]
...
3. Replace the bracketed sections with your personal details.  
4. Review, iterate, and export results.  

This consolidated guide removes the original hype and Twitter formatting while preserving every prompt exactly as intended. Copy the entire document into a .md or .doc file for easy reference.
